...
if (\Bitrix\Main\Loader::includeModule("sale")) {
    ...
    $arProfileProps = $arProfilePropsCodes = array();
    while ($prop = $dbProps->Fetch()){
        $arProfileProps[$prop["ID"]] = $prop["NAME"];
        $arProfilePropsCodes[$prop["CODE"]] = $prop["NAME"];
    }
    ...
    $arComponentParameters["PARAMETERS"]["SERVICE_ORDER_PROP"] = array(
        "TYPE" => "LIST",
        "MULTIPLE" => "N",
        "VALUES" => array_merge(array(0 => \Bitrix\Main\Localization\Loc::getMessage("NOT_SELECTED")), $arProfilePropsCodes),
        "DEFAULT" => "",
        "ADDITIONAL_VALUES" => "N",
        "NAME" => \Bitrix\Main\Localization\Loc::getMessage("SERVICE_ORDER_PROP"),
        "PARENT" => "PROPERTIES",
        "REFRESH" => "N"
    );
    $arComponentParameters["PARAMETERS"]["FILES_ORDER_PROP"] = array(
        "TYPE" => "LIST",
        "MULTIPLE" => "N",
        "VALUES" => array_merge(array(0 => \Bitrix\Main\Localization\Loc::getMessage("NOT_SELECTED")), $arProfilePropsCodes),
        "DEFAULT" => "",
        "ADDITIONAL_VALUES" => "N",
        "NAME" => \Bitrix\Main\Localization\Loc::getMessage("FILES_ORDER_PROP"),
        "PARENT" => "PROPERTIES",
        "REFRESH" => "N"
    );
